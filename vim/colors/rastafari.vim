...
hi PreProc      guifg=#666666 guibg=bg      gui=none term=none     cterm=none    ctermfg=darkgrey
hi PreCondit    guifg=#666666 guibg=bg      gui=none term=none     cterm=none    ctermfg=darkgrey
hi NonText      guifg=#ffff60 guibg=bg      gui=none term=none     cterm=none    ctermfg=yellow
hi Directory    guifg=#ffff60 guibg=bg      gui=none term=none     cterm=none    ctermfg=yellow
hi SpecialKey   guifg=#ffff60 guibg=bg      gui=none term=none     cterm=none    ctermfg=yellow
hi Type         guifg=#dddddd guibg=bg      gui=none term=none     cterm=none    ctermfg=white
...
hi Special      guifg=#ff8800 guibg=bg      gui=none term=none     cterm=none    ctermfg=darkgreen
hi Number       guifg=#aa2222 guibg=bg      gui=none term=none     cterm=none    ctermfg=darkred
hi MoreMsg      guifg=#80ff80 guibg=bg      gui=none term=none     cterm=none    ctermfg=green
...
hi TabLine      guifg=#80ff80 guibg=#008800 gui=none term=standout cterm=none    ctermfg=lightgreen ctermbg=lightgreen
hi TabLineSel   guifg=#ffff60 guibg=#008800 gui=none term=none     cterm=none    ctermfg=yellow     ctermbg=green
hi VertSplit    guifg=#80ff80 guibg=#008800 gui=none term=none     cterm=none    ctermfg=lightgreen ctermbg=green
hi TabLine      guifg=#66ff66 guibg=#008800 gui=none term=none     cterm=none    ctermfg=lightgreen
hi StatusLine   guifg=#66ff66 guibg=#008000 gui=none term=none     cterm=none    ctermfg=green      ctermbg=darkgrey
hi CursorColumn guifg=NONE    guibg=#111111 gui=none term=none     cterm=none    ctermfg=none       ctermbg=none
hi CursorLine   guifg=NONE    guibg=#111111 gui=none term=none     cterm=none    ctermfg=none       ctermbg=none
" Specific for c {{{1
...
" Specific for diff {{{1
hi DiffAdd      guifg=#ffff33 guibg=#404010 gui=none term=none cterm=none ctermfg=green
hi DiffChange                 guibg=#202020 gui=none term=none            ctermfg=darkgrey
hi DiffText     guifg=#3333ff guibg=#100040 gui=none term=none cterm=none ctermfg=blue
hi DiffDelete   guifg=#ff0000 guibg=#401010 gui=none term=none cterm=none ctermfg=red
hi diffLine     guifg=#444444 guibg=bg gui=none term=none cterm=none ctermfg=darkgrey
...
hi doxygenStart                guifg=#80ff80 guibg=bg gui=none term=none cterm=none ctermfg=lightgreen
hi doxygenStartL               guifg=#80ff80 guibg=bg gui=none term=none cterm=none ctermfg=lightgreen
...
hi doxygenPrevL                guifg=#80ff80 guibg=bg gui=none term=none cterm=none ctermfg=lightgreen
hi doxygenComment              guifg=#80ff80 guibg=bg gui=none term=none cterm=none ctermfg=lightgreen
...
hi doxygenParam                guifg=#80ff80 guibg=bg gui=none term=none cterm=none ctermfg=lightgreen
hi doxygenParamName            guifg=#3333ff guibg=bg gui=none term=none cterm=none ctermfg=blue
hi doxygenParamDirection       guifg=#ffff60 guibg=bg gui=none term=none cterm=none ctermfg=yellow
hi doxygenArgumentWord         guifg=#3333ff guibg=bg gui=none term=none cterm=none ctermfg=blue
hi doxygenCodeWord             guifg=#3333ff guibg=bg gui=none term=none cterm=none ctermfg=blue
hi doxygenHyperLink            guifg=#3333ff guibg=bg gui=none term=none cterm=none ctermfg=blue
" Specific for Vim script {{{1
hi vimCommentTitle guifg=#80ff80 guibg=bg      gui=none term=none cterm=none ctermfg=lightgreen
...
" Specific for Perl {{{1
hi perlSharpBang        guifg=#80ff80 guibg=bg gui=none term=standout cterm=none ctermfg=lightgreen
hi perlStatement        guifg=#aaaaaa guibg=bg gui=none term=none     cterm=none ctermfg=grey
hi perlStatementStorage guifg=#dddddd guibg=bg gui=none term=none     cterm=none ctermfg=white
...
" Specific for Ruby {{{1
hi rubySharpBang guifg=#80ff80 guibg=bg gui=none term=none cterm=none ctermfg=lightgreen
" Specific for the statusline {{{1
" My ~/.vimrc uses User1 and User2 in active statusline.
hi User1 guifg=#66ff66 guibg=#008000 gui=none term=standout cterm=none ctermfg=lightgreen ctermbg=lightgreen
hi User2 guifg=#ffff60 guibg=#008000 gui=none term=none     cterm=none ctermfg=yellow     ctermbg=lightgreen
" My ~/.vimrc uses User3 and User4 in non-active statusline.
hi User3 guifg=#66ff66 guibg=#008000 gui=none term=standout cterm=none ctermfg=lightgreen ctermbg=lightgreen
hi User4 guifg=#66ff66 guibg=#008000 gui=none term=none     cterm=none ctermfg=lightgreen ctermbg=lightgreen
" Specific for netrw {{{1
hi netrwTilde   guifg=#aaaaaa guibg=bg      gui=none term=none cterm=none ctermfg=grey
hi netrwExe     guifg=#aa2222 guibg=bg      gui=none term=none cterm=none ctermfg=darkred
hi netrwTags    guifg=#666666 guibg=bg      gui=none term=none cterm=none ctermfg=darkgrey
hi netrwTilde   guifg=#666666 guibg=bg      gui=none term=none cterm=none ctermfg=darkgrey
...
hi confluenceHeading       guifg=#ffff60 guibg=bg gui=none term=none cterm=none ctermfg=yellow
...
" Specific for XML {{{1
hi XmlTagName     guifg=#ffffff guibg=bg gui=none term=none cterm=none ctermfg=white
hi XmlEndTag      guifg=#ffffff guibg=bg gui=none term=none cterm=none ctermfg=white
hi XmlTag         guifg=#ffffff guibg=bg gui=none term=none cterm=none ctermfg=white
hi XmlAttrib      guifg=#666666 guibg=bg gui=none term=none cterm=none ctermfg=darkgrey
