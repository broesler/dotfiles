...
(Bernard-MBP | Mac)
    ...
    __conda_setup="$('/Users/bernardroesler/miniforge3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
    if [ $? -eq 0 ]; then
        eval "$__conda_setup"
    else
        if [ -f "/Users/bernardroesler/miniforge3/etc/profile.d/conda.sh" ]; then
            . "/Users/bernardroesler/miniforge3/etc/profile.d/conda.sh"
        else
            export PATH="/Users/bernardroesler/miniforge3/bin:$PATH"
        fi
    fi
    unset __conda_setup
    # <<< conda initialize <<<
    ...
    export MAMBA_EXE='/Users/bernardroesler/miniforge3/bin/mamba';
    export MAMBA_ROOT_PREFIX='/Users/bernardroesler/miniforge3';
